...
class TestGetFilesInfo(unittest.TestCase):
    def test_current_directory(self):
        ...
        self.assertIsNotNone(
            re.search(r"- main\.py: file_size=\d+ bytes, is_dir=False", result)
        )
        self.assertIsNotNone(
            re.search(r"- tests\.py: file_size=\d+ bytes, is_dir=False", result)
        )
        self.assertIsNotNone(
            re.search(r"- pkg: file_size=\d+ bytes, is_dir=True", result)
        )
        print(result)
    ...
    def test_pkg_directory(self):
        ...
        self.assertIsNotNone(
            re.search(r"- calculator\.py: file_size=\d+ bytes, is_dir=False", result)
        )
        self.assertIsNotNone(
            re.search(r"- render\.py: file_size=\d+ bytes, is_dir=False", result)
        )
        print(result)
